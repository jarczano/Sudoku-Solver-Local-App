...
from utils import load_dataset, load_label


def train_model_binary():
    """
    Function trains recognition model: full fields with digits and empty fields with noise.
    :return: Save model.h5 for binary recognition and information about his architecture and summary as model.txt
    """
    ...
    # Load dataset
    success, X = load_dataset(data='binary')
    if success:

        Y = load_label(data="binary")
        ...
        checkpoint_path = r"../model/cpr_binary-{epoch:04d}.h5"
        ...
        model_name = "model_binary{}".format(time.time())
